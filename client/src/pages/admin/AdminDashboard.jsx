        ...
        const fetchAdminData = async () => {
            try {
                ...
                const [statsRes, usersRes, campaignsRes] = await Promise.all([
                    axios.get((import.meta.env.VITE_API_URL || 'http://localhost:5001') + '/api/admin/stats', config),
                    axios.get((import.meta.env.VITE_API_URL || 'http://localhost:5001') + '/api/admin/users', config),
                    axios.get((import.meta.env.VITE_API_URL || 'http://localhost:5001') + '/api/admin/campaigns', config)
                ]);
